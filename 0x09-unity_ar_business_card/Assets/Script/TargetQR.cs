...
public class TargetQR : MonoBehaviour
{
    ...
    public Action onTargetOnEnable;
    ...
    protected virtual void OnTrackingFound()
    {
        if (mTrackableBehaviour)
        {
            ...
            var animationUI = mTrackableBehaviour.GetComponentsInChildren<AnimationUI>(true);
            onTargetOnEnable?.Invoke();
            ...
            // Enable animations':
            //foreach (var component in animationUI)
